<template>
    <div v-if='vxHomeInfo' class="man-love">
        <h3 class="title">
            男生喜欢
            <svg aria-hidden="false" class="icon icon-nanren">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            hotBookList() {
                return _get(this.vxHomeInfo[HOME_SHOW_TYPE.manLove].data, 'data').slice(0, 5) || []
            }
        },
        methods: {
            ...mapMutations({
            ...
            jumpToMore() {
                this.vxSetHomeInfoIndex({homeInfoIndex: HOME_SHOW_TYPE.manLove})
                this.$router.push({
                    name: 'moreBookList',
                })
            }
